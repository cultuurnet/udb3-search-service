...
final class SentryPsrLoggerDecorator implements LoggerInterface
{
    ...
    public function __construct(SentryExceptionHandler $sentryHandler, LoggerInterface $logger)
    {
    ...
    private function sendThrowableToSentry(array $context = array()): void
    {
        ...
        $this->sentryHandler->setInspector($inspector);
        $this->sentryHandler->handle();
    }
}
