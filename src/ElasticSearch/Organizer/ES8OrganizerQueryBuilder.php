...
use CultuurNet\UDB3\Search\ElasticSearch\AbstractES8QueryBuilder;
...
final class ES8OrganizerQueryBuilder extends AbstractES8QueryBuilder implements
    OrganizerQueryBuilderInterface
{
    ...
    public function withAutoCompleteFilter(string $input): ES8OrganizerQueryBuilder
    {
    ...
    public function withWebsiteFilter(string $url): ES8OrganizerQueryBuilder
    {
    ...
    public function withDomainFilter(string $domain): ES8OrganizerQueryBuilder
    {
    ...
    public function withPostalCodeFilter(PostalCode $postalCode): ES8OrganizerQueryBuilder
    {
    ...
    public function withAddressCountryFilter(Country $country): ES8OrganizerQueryBuilder
    {
        return $this->withMultiFieldMatchQuery(
            (new KnownLanguages())->fieldNames(
    ...
    public function withCreatorFilter(Creator $creator): ES8OrganizerQueryBuilder
    {
        return $this->withMatchQuery('creator', $creator->toString());
    }

    public function withLabelFilter(LabelName $label): ES8OrganizerQueryBuilder
    {
        return $this->withMatchQuery('labels', $label->toString());
    }

    public function withWorkflowStatusFilter(WorkflowStatus ...$workflowStatuses): ES8OrganizerQueryBuilder
    {
    ...
    public function withSortByScore(SortOrder $sortOrder): ES8OrganizerQueryBuilder
    {
        return $this->withFieldSort('_score', $sortOrder->toString());
    }

    public function withSortByCompleteness(SortOrder $sortOrder): ES8OrganizerQueryBuilder
    {
        return $this->withFieldSort('completeness', $sortOrder->toString());
    }

    public function withSortByCreated(SortOrder $sortOrder): ES8OrganizerQueryBuilder
    {
        return $this->withFieldSort('created', $sortOrder->toString());
    }

    public function withSortByModified(SortOrder $sortOrder): ES8OrganizerQueryBuilder
    {
