...
final class ElasticSearchOfferQueryBuilderTest extends AbstractElasticSearchQueryBuilderTest
{
     ...
     * @test
     */
    public function it_can_build_a_query_with_an_overnight_filter_on_sub_event(): void
    {
        $builder = (new ElasticSearchOfferQueryBuilder())
            ->withStartAndLimit(new Start(0), new Limit(30))
            ->withSubEventFilter(
     ...
     * @test
     */
    public function it_should_build_a_query_with_an_overnight_filter(): void
    {
        $builder = (new ElasticSearchOfferQueryBuilder())
            ->withStartAndLimit(new Start(30), new Limit(10))
            ->withOvernightFilter(true);
     ...
     * @test
     */
    public function it_should_build_a_query_with_an_overnight_false_filter(): void
    {
        $builder = (new ElasticSearchOfferQueryBuilder())
            ->withStartAndLimit(new Start(30), new Limit(10))
            ->withOvernightFilter(false);
