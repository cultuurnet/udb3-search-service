...
abstract class AbstractElasticSearchOfferQueryBuilderTest extends AbstractElasticSearchQueryBuilderTest
{
    abstract protected function createBuilder(int $aggregationSize = null): OfferQueryBuilderInterface;
