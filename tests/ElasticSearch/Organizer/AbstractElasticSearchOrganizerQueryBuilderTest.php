...
abstract class AbstractElasticSearchOrganizerQueryBuilderTest extends AbstractElasticSearchQueryBuilderTest
{
    abstract protected function createBuilder(int $aggregationSize = null): OrganizerQueryBuilderInterface;
